...
$ npm install gulp-concat@2 --save-dev
...
$ npm install locallydb@0.0.9 --save
$ npm install express-session@1.12 --save
$ npm install cookie-parser@1.4 --save
$ npm install body-parser@1.14 --save
$ npm install moment@2.11 --save
